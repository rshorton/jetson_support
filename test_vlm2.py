...
prompt6 = 'Please caption the notable attributes in the provided image. List and describe all marked subjects in the image with their categories, detailed captions, and bounding boxes using json with keyword "subject_id", "category", "caption", and "bounding box".'
prompt7 = 'What are the coordinates of the persons elbow in the image?'
