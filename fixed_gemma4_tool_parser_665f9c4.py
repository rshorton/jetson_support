...
class Gemma4ToolParserFixed(ToolParser):
    """
    Tool call parser for Google Gemma4 models.
...
# rshorton change:
# Register using a different name to make sure it is really used
from vllm.tool_parsers import ToolParserManager
ToolParserManager.register_module(name="my_fixed_gemma_parser", module=Gemma4ToolParserFixed)
